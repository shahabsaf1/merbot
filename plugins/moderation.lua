do
  ...
  return {
    ...
    usage = {
      moderator = {
        '!p : If typed when replying, promote replied user as moderator',
        '!p <user_id> : Promote user_id as moderator',
        '!p @<username> : Promote username as moderator',
        '!d : If typed when replying, demote replied user from moderator',
        '!d <user_id> : Demote user_id from moderator',
        '!d @<username> : Demote username from moderator',
        '!modlist : List of moderators'
        },
      sudo = {
        '!adminp : If typed when replying, promote replied user as admin.',
        '!adminp <user_id> : Promote user_id as admin.',
        '!adminp @<username> : Promote username as admin.',
        '!admind : If typed when replying, demote replied user from admin.',
        '!admind <user_id> : Demote user_id from admin.',
        '!admind @<username> : Demote username from admin.'
        },
      },
    patterns = {
      '^!(admind) (%d+)$',
